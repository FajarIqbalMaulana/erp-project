...
use App\Http\Controllers\main_page\MainPageLanding;
...
// First Landing
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified', 'role:Super Admin|Direksi|manager|Kepala|Staff'])->group(function () {

    // Main Page Route
    Route::get('/', [MainPageLanding::class, 'index']);
